...
<header className="body-font fixed  left-0 right-0 bg-blue-500 p-4 z-10 text-white my-0">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
      <a href='Hero' className="mr-5 hover:text-gray-900">About</a>
      <a href='Education' className="mr-5 hover:text-gray-900">Education</a>
    ...
    <a href="/Contact" className="inline-flex items-center bg-white border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 text-black rounded text-base mt-4 md:mt-0">
  Get In Touch
